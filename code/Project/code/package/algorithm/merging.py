...
def spatialDenoisePatches_(patchesFFT, WienerCoeff):
	...
	# Wiener filtering
	# print("Test1:" , patchesFFT)
	# print("1", type(dist))
	# print("2", type(WienerCoeff))
	# print("Test2:" , dist)
	# print("Test3:" , WienerCoeff)
	# print(dist + WienerCoeff)
...
def spatialDenoisePatches(patchesFFT, noiseVariance, spatialFactor):
	...
	# print(distPatchShift * noiseScaling * noiseVariance)
	# print(type(distPatchShift * noiseScaling * noiseVariance))
	# print((distPatchShift * noiseScaling * noiseVariance).shape)
	# print(type(patchesFFT))
	# print(patchesFFT.shape)
	# print(type(spatialDenoisePatches_(patchesFFT, distPatchShift * noiseScaling * noiseVariance)))
